...
.put((req, res, next) => {
    res.statusCode = 403
    res.end("Oopsie, looks like PUT operation is not supported on /dishes/"+req.params.dishId+"/comments")
})
...
.post((req, res, next) => {
    res.statusCode = 403
    res.end("Oopsie, looks like POST operation is not supported on /dishes/"+req.params.dishId+"/comments/"
